...
Begin VB.Form Main_Combine 
   ...
   End
End
Attribute VB_Name = "Main_Combine"
...
Dim iStr() As String, i As Long, readconfigpath As String, config As String, pathini As String
